...
export const projects: Project[] = [
    ...
    // ─── 01 LEMON CASH ────────────────────────────────────────────────────────
    {
        ...
        sidebar: {
            ...
            logoClassName: 'w-[130px] md:w-[160px]',
        ...
        gallery: [
            { type: 'text', title: 'THE IDEA:', text: 'Visualizar lo invisible. La idea del spot fue reventar la caja negra de una transacción tradicional. Combinamos live-action crudo con animación 3D para meternos literalmente en las entrañas del posnet y documentar el viaje frenético del cashback.' },
            { type: 'full', src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_row-0-1x_f` },
            {
                type: 'custom', src: [
                    { src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_custom-2-0_1x`, width: 440, height: 520, className: 'ml-4 md:ml-8 lg:ml-12 lg-custom-img-left' },
                    { src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_custom-2-1_1x`, width: 340, height: 340, className: 'mt-6 md:mt-12 mx-auto lg-custom-img-right' },
                ], className: 'grid grid-cols-1 md:grid-cols-2 mt-12 w-full gap-8 items-start lg-custom-grid-2'
            },
            { type: 'text', variant: 'centered', title: 'BELIER.TV\nIN DA HAUS', src: `${b('lemon', 'campania_qr')}/gallery_detail/claim_lemon_1x`, className: 'ml-6 md:ml-12 lg:ml-20 -mt-6 md:-mt-10 lg:-mt-12', titleClassName: '-rotate-[8deg] translate-y-10', imageClassName: '' },
            { type: 'half', src: [`${b('lemon', 'campania_qr')}/gallery_detail/gallery_row-4_1x_h`, `${b('lemon', 'campania_qr')}/gallery_detail/lemon_video_full.mp4`] },
            { type: 'text', title: 'OUTCOME:', text: 'Disparamos las descargas y reventamos el engagement de la app con el lanzamiento del pago vía QR. Más allá del feature tecnológico, consolidamos el sentido de pertenencia: convertimos a los usuarios en verdaderos insiders de la cultura Lemon.' },
            { type: 'full', src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_row-6_1x_f` },
            {
                type: 'custom', src: [
                    { src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_custom-7-0_1x`, width: 340, height: 340, className: 'mt-6 md:mt-12 mx-auto lg-custom-img-up lg-emy-large' },
                    { src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_custom-7-1_1x`, width: 380, height: 450, className: 'm-auto' },
                ], className: 'grid grid-cols-1 md:grid-cols-2 w-full gap-8 my-4 md:my-8 lg:my-12 lg-items-center lg-custom-grid-7'
            },
            {
                type: 'custom', src: [
                    { src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_custom-8-0_1x`, width: 640, className: 'lg-img-8-0' },
                    { src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_custom-8_1`, width: 560, className: 'my-auto mx-auto lg:mr-24 lg-img-8-1' },
                ],
                className: 'grid grid-cols-1 md:grid-cols-[2fr_1fr] lg:grid-cols-[3fr_1fr] gap-8 md:gap-16 lg:gap-24 mb-8 lg-scaled-grid-8'
            },
            { type: 'full', src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_row-5_2x_h` },
            {
                ...
                ], className: 'grid grid-cols-1 md:grid-cols-2 mt-12 w-full gap-8 items-start lg-bottom-section'
            },
            { type: 'full', src: `${b('lemon', 'campania_qr')}/gallery_detail/gallery_row-6_2x_h`, className: 'mt-6 md:mt-12 lg:mt-12' },
        ],
    },
    ...
    // ─── 02 CONVERSE ALL STARS ────────────────────────────────────────────────
    {
        ...
        gallery: [
            ...
            { type: 'text', title: 'OUTCOME:', text: 'Creating with intent, Converse All Stars change the world through sustainability, diversity, inclusion & belonging and youth development.Who is a Converse All Star?' },
    ...
    // ─── 03 MAXIBON ───────────────────────────────────────────────────────────
    {
        ...
        { type: 'text', title: 'OUTCOME:', text: 'Logramos un relanzamiento explosivo que respondió directamente al pedido de la audiencia, uniendo a los dos sabores de la manera más auténtica y "Maxibon" posible. El resultado fue una campaña inmersiva y memorable que consolidó a la marca dentro del ecosistema urbano a través de pura adrenalina visual y diversión absurda.', className: 'lg-text-outcome' },
    ...
    // ─── 05 DORITOS ───────────────────────────────────────────────────────────
    {
        ...
        gallery: [{ type: 'text', title: 'THE IDEA:', text: 'Darle volumen a lo que callamos. Traducir esa batalla interna en un choque visual crudo, donde el ruido mental tomara el control absoluto de la pantalla para exponer la tensión real entre la fachada que mostramos y lo que sentimos por dentro.' },
...

        {
            ...
            className: 'grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 lg:gap-16 mb-12 items-start',
            //overlayText: 'BE BOLD.\nREACH OUT.',
            overlayClassName: 'absolute bottom-[0%] left-3/4 -translate-x-1/2 z-10',
            overlayTextClassName: '-rotate-[4deg] text-center'
        },
        ...
        { type: 'interactive-video', loop: `${b('doritos', 'campania')}/gallery_detail/detail_doritos_cafe-loop`, aspect: 'aspect-video', src: `${b('doritos', 'campania')}/gallery_detail/detail_doritos_cafe.mp4` },
        {
            ...
            className: 'grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 lg:gap-16 mb-16 items-start'
        },
    ...
    // ─── 06 CASH APP ──────────────────────────────────────────────────────────
    {
        ...
        gallery: [{ type: 'text', title: 'THE IDEA:', text: 'Mutar la idea sin perder nuestra visión. A través de tres viñetas surrealistas, adaptamos la propuesta para celebrar la libertad de gastar con estilo propio, demostrando que la app siempre juega a tu favor.' },
        { type: 'full', aspect: 'aspect-auto', src: `${b('cashapp', 'advertising')}/gallery_detail/gallery_row-1_1x_f` },
        { type: 'text', title: 'OUTCOME:', text: 'Transformamos un freno de preproducción en una ejecución premium. Demostramos agilidad extrema frente a la presión y entregamos una campaña magnética que logró que la independencia financiera se vea más audaz que nunca.' },
    ...
    // ─── 09 ITAÚ ──────────────────────────────────────────────────────────────
    {
        ...
        gallery: [{ type: 'text', title: 'THE IDEA:', text: 'Generar empatía a través de la inmersión total. Diseñamos una cabina interactiva donde los colaboradores se enfrentaban a grabaciones reales de atención al cliente. Un espacio físico para escuchar sin filtros, entender cada escenario y aprender el mejor abordaje para cada caso.' },
...

        {
            ...
            className: 'grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 lg:gap-16 mb-32 items-start itau-grid-1',
            overlayText: 'ESCUCHANDO AL CLIENTE',
            overlayClassName: 'absolute bottom-[0%] left-3/4 -translate-x-1/2 z-10 itau-overlay-text',
            overlayTextClassName: '-rotate-[4deg] text-center'
        },
        { type: 'text', title: 'OUTCOME:', text: 'Rompimos la burbuja corporativa. Transformamos un simple mensaje de comunicación interna en una herramienta de aprendizaje tangible y memorable. Logramos que el equipo internalice el valor de escuchar, mejorando su capacidad estratégica de respuesta ante el cliente.' },
    ...
    // ─── 13 ALTO PALERMO ──────────────────────────────────────────────────────
    {
        ...
        gallery: [
            ...
            { type: 'text', title: 'THE IDEA:', text: 'Transformar el punto de partida en el corazón del evento. Diseñamos el hub principal de la experiencia combinando infraestructura técnica, entretenimiento en vivo y un fuerte sentido de comunidad para elevar la adrenalina de los participantes antes y después de pedalear.' },
            ...
            { type: 'text', title: 'OUTCOME:', text: 'Energía al máximo y presencia de marca impecable. Logramos que una multitud vibrara al unísono desde el primer minuto, en una jornada que posicionó a Alto Palermo más allá del retail, consolidándolo como un promotor activo del bienestar en la ciudad.' },
